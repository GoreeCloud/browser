...
- Complete navigation/address safety for malformed URLs, schemes/deep links, user-info disclosure, Unicode confusable/spoofing analysis beyond the implemented A-label host canonicalization, origin/certificate presentation, and bidirectional text.
