...
- Complete remaining navigation/address safety for malformed URLs, schemes/deep links, user-info disclosure, IDN/confusable/spoofing, origin/certificate presentation, and full bidirectional/RTL acceptance beyond the current Browser-chrome bidi-control stripping.
