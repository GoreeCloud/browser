...
- Complete Browser-wide GLAZE UI V1.6 / 1.6.0 adoption beyond the current Android/Linux source-mapping tranche, then complete Browser-specific rendered, accessibility, large-text, localization/RTL, adaptive/form-factor/posture, reduced-effects, performance, rollback, Human Visual Excellence, and representative-device acceptance.
