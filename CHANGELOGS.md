...
- Promoted the verified minimal CEF archive identities into repository-owned dependency pins: SHA-1 `9711b86c105fb590da576fe5a829802f1a79d520` and SHA-256 `daf8c2b6e63787d6a91d666205a8a4521419937eabaf47723738c86aea7135bd`.
- Corrected the Chromium adapter smoke target to use the checked-in `apps/browser/chromium_adapter_smoke.cpp` source instead of the nonexistent `apps/browser/chromium_smoke.cpp`.
